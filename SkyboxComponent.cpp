...
SkyboxComponent::SkyboxComponent(float size, Texture** textures) : textures(textures){
	...
	vertexLeft.push_back(Vertex::PTN(p + glm::vec3(x, y + size, z), glm::vec2(1, 1), glm::vec3(0, -1, 0)));
	vertexLeft.push_back(Vertex::PTN(p + glm::vec3(x, y + size, z + size), glm::vec2(0, 1), glm::vec3(0, -1, 0)));
	vertexLeft.push_back(Vertex::PTN(p + glm::vec3(x, y, z + size), glm::vec2(0, 0), glm::vec3(0, -1, 0)));
	vertexLeft.push_back(Vertex::PTN(p + glm::vec3(x, y, z), glm::vec2(1, 0), glm::vec3(0, -1, 0)));
	...
	vertexBottom.push_back(Vertex::PTN(p + glm::vec3(x, y, z), glm::vec2(1, 1), glm::vec3(0, -1, 0)));
	vertexBottom.push_back(Vertex::PTN(p + glm::vec3(x, y, z + size), glm::vec2(0, 1), glm::vec3(0, -1, 0)));
	vertexBottom.push_back(Vertex::PTN(p + glm::vec3(x + size, y, z + size), glm::vec2(0, 0), glm::vec3(0, -1, 0)));
	vertexBottom.push_back(Vertex::PTN(p + glm::vec3(x + size, y, z), glm::vec2(1, 0), glm::vec3(0, -1, 0)));
	verts.push_back(vertexBottom);

	//top
	std::vector<Vertex> vertexTop;
	vertexTop.push_back(Vertex::PTN(p + glm::vec3(x + size, y + size, z), glm::vec2(1, 1), glm::vec3(0, -1, 0)));
	vertexTop.push_back(Vertex::PTN(p + glm::vec3(x + size, y + size, z + size), glm::vec2(0, 1), glm::vec3(0, -1, 0)));
	vertexTop.push_back(Vertex::PTN(p + glm::vec3(x, y + size, z + size), glm::vec2(0, 0), glm::vec3(0, -1, 0)));
	vertexTop.push_back(Vertex::PTN(p + glm::vec3(x, y + size, z), glm::vec2(1, 0), glm::vec3(0, -1, 0)));
